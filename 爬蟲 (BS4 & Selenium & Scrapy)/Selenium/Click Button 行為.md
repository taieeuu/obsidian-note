目標網站: https://www.adamchoi.co.uk/overs/detailed
1. 找到Button的元素
![[Pasted image 20240107114150.png]]
2. 且在html搜索出該button的元素
![[Pasted image 20240107114636.png]]
## Code
1. finding the element button to click
```python
