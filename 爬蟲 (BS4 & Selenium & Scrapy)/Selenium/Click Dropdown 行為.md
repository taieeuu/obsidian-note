目標網站: [https://www.adamchoi.co.uk/overs/detailed](https://www.adamchoi.co.uk/overs/detailed)
1. 找到dropdown元素
![[Pasted image 20240107135836.png]]2.  且在html搜索出該dropdown的元素
![[Pasted image 20240107140037.png]]
## Code
1. finding the element dropdown to click
```python
...
```
2. then download the page data to csv
```python
